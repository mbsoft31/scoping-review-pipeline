...
class SearchQueueManager:
    ...
    You don't need to understand async - just use this API!
    ...
    def __init__(
        ...
        self.orchestrator = SearchOrchestrator(cache_dir=cache_dir)
        ...
        logger.info(f"SearchQueueManager initialized with {num_workers} workers")
    ...
    def run_all(self, show_progress: bool = True, progress_interval: float = 2.0):
        """
